    ...
    <section className='bg-white dark:bg-slate-900 py-20'>
      <div className='mx-auto px-4 max-w-7xl container'>
        <div
          ...
          <h2 className='font-bold text-3xl text-center underline decoration-[#FFA500] dark:decoration-[#ffb74d] dark:text-white'>
            Tentang Tracer Study
          </h2>
          <p className='mx-auto mt-3 mb-12 max-w-3xl text-center text-gray-600 dark:text-slate-300'>

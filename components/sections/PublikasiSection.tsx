      ...
      <div className='mx-auto'>
        <div className='gap-3 grid grid-cols-12'>
          <div className='col-span-12'>
            <div
              className='flex justify-center items-center bg-[#4FBEBC] px-5 lg:px-0 py-16 font-bold font-roboto text-2xl text-center text-white xl:text-3xl underline decoration-[#FFA500]'
              style={{
              ...
              <h1 className='mx-auto max-w-6xl'>Publikasi</h1>
            </div>

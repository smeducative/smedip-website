          ...
          <div className="col-span-12 lg:col-span-8">
            <div className="flex flex-col items-start justify-center">
              ...
              <p className="mt-5 font-roboto text-sm lg:text-base">
                ...
                dapat kami perbaharui. Kami mengucapkan selamat datang di
                website kami Sekolah Menegah Kejuruan (SMK) Diponegoro
                Pekalongan yang kami tunjukan untuk seluruh pimpinan, guru,
                karyawan dan siswa serta khalayak umum guna dapat mengakses
                seluruh informasi tentang aktifitas dan kegiatan serta fasilitas
                sekolah kami.
              </p>
            </div>
          </div>

...
const testimonials = [
  {
    avatar: "/assets/images/testimonials/AbdulAziz.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/AgungSuparno.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/AhmadPrastio.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/ArinaIfati.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/ArumSari.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/DaniIkhwan.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/SandiPurnomoAji.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/AlimAssidiq.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/KhoirulImam.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/WadiYulianto.jpg",
    quote:
      "Belajar di SMK Diponegoro tidak hanya melatih hard skill montir, tetapi juga membentuk mental petarung dan kedisiplinan tinggi. Berkat bimbingan intensif dari sekolah, saya bisa lolos seleksi kerja dan adaptasi dengan cepat di lingkungan industri Jepang.",
    name: "Wadi Yulianto",
  ...
  {
    avatar: "/assets/images/testimonials/ReniMeilia.jpg",
    quote:
  ...
  {
    avatar: "/assets/images/testimonials/RicoHamzah.jpg",
    quote:
